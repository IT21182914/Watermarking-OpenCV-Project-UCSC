...
if __name__ == "__main__":
    ...
    # Activity 5: Detect Watermarks and Plot Results
    ...
    print(results_set1)
    print("Results for Gaussian Noise Set:")
    print(results_gaussian)
    print("Results for Shot Noise Set:")
    print(results_shot)
    print("Results for Salt & Pepper Noise Set:")
    print(results_salt_pepper)

    plot_correlation_values(results_set1['correlations'], "Watermarked Set 1", 100, -50)
    plot_correlation_values(results_gaussian['correlations'], "Gaussian Noise Set", 100, -50)
    plot_correlation_values(results_shot['correlations'], "Shot Noise Set", 100, -50)
    plot_correlation_values(results_salt_pepper['correlations'], "Salt & Pepper Noise Set", 100, -50)
    ...
    print(f"False Positive Rate for Gaussian Noise: {fpr_gaussian}")
    print(f"False Positive Rate for Shot Noise: {fpr_shot}")
    print(f"False Positive Rate for Salt & Pepper Noise: {fpr_salt_pepper}")
